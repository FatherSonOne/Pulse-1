...
export const TOOLS: Tool[] = [
  ...
  },
  {
    id: 'smart-reply',
    name: 'Smart Reply',
    description: 'One-shot AI reply based on the thread',
    icon: 'fa-reply',
    category: 'write',
    keywords: ['reply', 'smart', 'auto', 'respond'],
  },
  {
    id: 'voice-extractor',
    name: 'Voice Note',
    description: 'Transcribe speech and pull out action items',
    icon: 'fa-microphone-lines',
    category: 'write',
    keywords: ['voice', 'transcribe', 'dictate', 'note', 'action', 'extract'],
  },
  {
    id: 'schedule-message',
    name: 'Schedule',
    description: 'Send this draft later',
    icon: 'fa-clock',
    category: 'write',
    keywords: ['schedule', 'later', 'defer', 'delay', 'send'],
  },
  {
    id: 'proposal-mode',
    name: 'Proposal Mode',
    description: 'Mark the next message as a binding proposal',
    icon: 'fa-gavel',
    category: 'write',
    keywords: ['proposal', 'propose', 'vote', 'decision', 'binding'],
  },
  {
