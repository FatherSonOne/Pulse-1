          ...
          {folders.map((folder) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left transition-all mb-0.5 ${isActive
              ...
              >
                ...
                {count > 0 && (
                  <span
                    className={`text-xs font-medium px-2 py-0.5 rounded-full ${isActive ? 'bg-rose-500 text-white' : 'bg-stone-200 dark:bg-zinc-800 text-stone-600 dark:text-zinc-400'
                      }`}
                    aria-hidden="true"
                  >
                    {count > 99 ? '99+' : count}
