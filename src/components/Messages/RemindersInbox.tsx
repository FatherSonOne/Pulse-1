    ...
    <li className="p-3 hover:bg-zinc-100/60 dark:hover:bg-white/[0.04] transition-colors">
      <div className="flex items-start justify-between gap-2">
        ...
        <button
          ...
          onClick={onDismiss}
          disabled={busy}
          className="p-1.5 rounded-md text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 hover:bg-[var(--pulse-surface-raised)] transition disabled:opacity-50"
