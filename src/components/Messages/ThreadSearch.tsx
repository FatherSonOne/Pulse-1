      ...
      <div className="relative">
        ...
        {value && (
          <motion.button
            ...
            onClick={handleClear}
            className="absolute right-3 top-1/2 -translate-y-1/2 p-1 rounded hover:bg-[var(--pulse-surface-raised)] dark:hover:bg-[rgba(255,255,255,0.10)] transition-colors"
