...
import { Activity, ArrowLeft, BarChart, Calendar, CalendarPlus, Check, CheckCircle2, ChevronDown, Copy, Download, FileText, Film, Gavel, Inbox, Info, Loader2, Mic, Monitor, PieChart, Play, PlayCircle, Plus, Search, Settings, Sliders, Trash2, TrendingUp, Upload, UserPlus, Users, Video, VideoOff, Volume2, Wand2, X, Zap } from 'lucide-react';
