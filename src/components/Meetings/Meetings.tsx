      ...
      <div className="meetings-container">
        ...
        <div className="mtg-dashboard">
          <main className="mtg-dashboard-main">
            {/* Rail kicker stats now derive from native pulse_video_rooms
                analytics (#121), so they always reflect real Pulse meeting
                counts — no Entomate gate. The kicker only renders meaningfully
                once there are meetings to count. */}
            <MeetingsRailKicker
