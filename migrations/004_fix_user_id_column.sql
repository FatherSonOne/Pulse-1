-- ============================================
-- Fix google_contacts_sync_jobs user_id column type
-- Change from UUID to TEXT to support string user IDs
-- ============================================

-- Drop existing table and recreate with correct schema
DROP TABLE IF EXISTS public.google_contacts_sync_jobs;

-- Create the sync jobs table with TEXT user_id
...
-- Add comment
COMMENT ON TABLE public.google_contacts_sync_jobs IS 'Tracks Google Contacts sync operations for Logos Vision CRM integration (user_id as TEXT)';
