-- Sample Data for AI-Enhanced Decisions & Tasks (FIXED VERSION)
-- This creates realistic test data using the CORRECTED database schema
-- IMPORTANT: Run fix_tasks_workspace_id.sql BEFORE running this file
...
-- ============================================
-- SAMPLE TASKS (NOW WITH workspace_id!)
-- Actual columns: id, user_id, workspace_id, title, completed, due_date, list_id, assignee_id, origin_message_id, priority, created_at, updated_at
-- AI columns: ai_priority_score, ai_suggested_assignee, ai_predicted_duration
-- ============================================
...
INSERT INTO tasks (
  ...
  gen_random_uuid(),
  (SELECT id FROM auth.users LIMIT 1),
  (SELECT id FROM auth.users LIMIT 1), -- workspace_id
